...
function SongCard({ song }) {
  ...
  return (
    <div 
      onClick={handlePlay}
      className="bg-gradient-to-br from-violet-800 to-purple-900 p-4 rounded-xl w-[200px] h-[280px] flex-shrink-0 hover:from-violet-700 hover:to-purple-800 transition-all duration-300 cursor-pointer shadow-lg hover:shadow-purple-500/50 hover:scale-105 border border-violet-700/30 flex flex-col"
    >
      <img 
        src={song.albumArt} 
        alt={song.title} 
