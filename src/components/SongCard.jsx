...
function SongCard({ song, compact = false }) {
  ...
  return (
    <div 
      onClick={handlePlay}
      className={`bg-gradient-to-br from-fuchsia-900 to-indigo-950 p-2.5 sm:p-3 rounded-xl ${cardSize} flex-shrink-0 hover:from-fuchsia-800 hover:to-indigo-900 transition-all duration-300 cursor-pointer shadow-lg hover:shadow-fuchsia-500/30 hover:scale-[1.02] border border-white/10 flex flex-col`}
    >
      <img 
        src={song.albumArt} 
        alt={song.title} 
