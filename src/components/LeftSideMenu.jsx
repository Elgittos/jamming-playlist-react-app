        ...
        <div className="p-4 flex items-center justify-between border-b border-fuchsia-800/30">
          ...
          >
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              {isPinned ? (
                // Pinned icon (filled pushpin)
                <path fillRule="evenodd" d="M10 2a1 1 0 011 1v1.323l3.954 1.582 1.599-.8a1 1 0 01.894 1.79l-1.233.616 1.738 5.42a1 1 0 01-.285 1.05A3.989 3.989 0 0115 15a3.989 3.989 0 01-2.667-1.019 1 1 0 01-.285-1.05l1.715-5.349L11 6.477V16h2a1 1 0 110 2H7a1 1 0 110-2h2V6.477L6.237 7.582l1.715 5.349a1 1 0 01-.285 1.05A3.989 3.989 0 015 15a3.989 3.989 0 01-2.667-1.019 1 1 0 01-.285-1.05l1.738-5.42-1.233-.617a1 1 0 01.894-1.788l1.599.799L9 4.323V3a1 1 0 011-1z" clipRule="evenodd" />
              ) : (
                // Unpinned icon (outline pushpin)
                <path d="M10 3a1 1 0 00-1 1v.25L5.5 5.5l-.5-.25a.5.5 0 00-.707.707l.147.147L3.354 7.19a.5.5 0 000 .707l1.768 1.768-3.182 3.182a.5.5 0 00.708.707l3.182-3.182 1.768 1.768a.5.5 0 00.707 0l1.086-1.086.147.147a.5.5 0 00.707-.707l-.25-.5 1.25-3.5V4a1 1 0 00-1-1zm0 10.5V17h2a.5.5 0 010 1H8a.5.5 0 010-1h2v-3.5z" />
              )}
            </svg>
          </button>
        </div>
