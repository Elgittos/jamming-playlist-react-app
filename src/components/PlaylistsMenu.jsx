  ...
  return (
    <div className="w-full bg-gradient-to-br from-indigo-900 via-purple-950 to-black rounded-2xl shadow-2xl p-10 border border-indigo-800/30">
      ...
      <div className="relative">
        ...
        <div className="flex gap-6 overflow-x-auto pb-4 scrollbar-thin scrollbar-thumb-indigo-700 scrollbar-track-indigo-950">
          {playlists.map((playlist) => (
            <div
              key={playlist.id}
              onClick={() => onPlaylistSelect(playlist.id)}
              className={`flex-shrink-0 w-[200px] h-[280px] bg-gradient-to-br from-indigo-800/50 to-purple-900/50 rounded-xl overflow-hidden cursor-pointer transition-all duration-300 hover:scale-105 hover:shadow-2xl border-2 ${
